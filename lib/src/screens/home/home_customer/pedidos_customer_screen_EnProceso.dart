...
@RoutePage()
class PedidosCustomerScreenEnProceso extends StatefulWidget {
  const PedidosCustomerScreenEnProceso({
    super.key,
  });

  @override
  State<PedidosCustomerScreenEnProceso> createState() => _PedidosCustomerScreenState();
}

class _PedidosCustomerScreenState extends State<PedidosCustomerScreenEnProceso> {
  @override

...
@RoutePage()
class PedidosCustomerScreenEnviados extends StatefulWidget {
  const PedidosCustomerScreenEnviados({
    super.key,
  });

  @override
  State<PedidosCustomerScreenEnviados> createState() => _PedidosCustomerScreenState();
}

class _PedidosCustomerScreenState extends State<PedidosCustomerScreenEnviados> {
  @override
                  ...
                  child: Card(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        if (snapshot.data?[index]['state'] == "Pendiente" && snapshot.data?[index]['idCustomer'] == idUser) ...[
                          ListTile(
                            leading: IconButton(
                              onPressed: () {

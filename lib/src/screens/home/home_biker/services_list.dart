...
@RoutePage()
class HomeBikerScreenServices extends StatefulWidget {
  const HomeBikerScreenServices({
    super.key,
  });

  @override
  State<HomeBikerScreenServices> createState() =>
      _HomeBikerScreenServicesState();
}

class _HomeBikerScreenServicesState extends State<HomeBikerScreenServices> {
  @override
